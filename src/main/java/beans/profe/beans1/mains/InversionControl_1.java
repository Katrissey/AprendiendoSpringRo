package beans.profe.beans1.mains;

import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;

import beans.profe.beans1.beans.HelloWorld;
...
public class InversionControl_1 {
	...
	public static void main(String args[]){
		...
		//solo ser�a necesario cambiar el xml
		...
		//BeanFactory Es la clase base sobre la que se asienta la inversion de control, es el interfaz b�scio
